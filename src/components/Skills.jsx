...
function Skills() {
    return (
        <>
            <div>
                <h2 id="skills" className="text-4xl md:text-6xl font-semibold tracking-wide text-blue-300 mb-4 my-5 text-center">
                    Skills
                </h2>
                <div className='max-w-6xl mx-auto mt-16'>
                    <div>
                        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4'>
                            ...
                            <div className='bg-black shadow-xl shadow-gray-600 transition-transform transition-duration-3000 hover:scale-105'>
                                <img src="/github.png" className="w-20 mx-auto mb-4 mt-4" alt="" />
                                <p className='text-white text-lg text-center'>
                                    Github
                                </p>
                            </div>
                            <div className='bg-black shadow-xl shadow-gray-600 transition-transform transition-duration-3000 hover:scale-105'>
                                <img src="/redux.png" className="w-20 mx-auto mb-4 mt-4" alt="" />
                                <p className='text-white text-lg text-center'>
                                    Redux
                                </p>
                            </div>
